...
local palette = {
    ...
    sumiInk2 = "#1a1a22",
    sumiInk3 = "#1F1F28",  --bg
    -- sumiInk3_ = "#212229", --color column
    sumiInk3_ = "#242430", --color column
    sumiInk4 = "#2A2A37",
    sumiInk5 = "#363646",
    sumiInk6 = "#54546D", --fg
...
function M.setup(opts)
    opts = opts or {}
    local override_colors = opts.colors or require("kanagawa-again.config").options.colors

    -- Add to and/or override palette_colors
    local updated_palette_colors = vim.tbl_extend("force", palette, override_colors.palette or {})

    -- Generate the theme according to the updated palette colors
    local theme_colors = require("kanagawa-again.themes")(updated_palette_colors)
