...
---@field lualine_error ColorSpec
---@field lualine_ok ColorSpec
---@field lualine_warning ColorSpec
---@field lualine_info ColorSpec
---@field lualine_hint ColorSpec
...
return function(palette)
    ...
    return {
        ...
        diag = {
            ...
            lualine_error = palette.autumnRed,
            lualine_ok = palette.autumnGreen,
            lualine_warning = palette.autumnYellow,
            lualine_info = palette.dragonBlue,
            lualine_hint = palette.waveAqua1,
        },
        term = {
