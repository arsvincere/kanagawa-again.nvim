...
function M.setup(colors, opts)
    ...
    return {
        ...
        ColorColumn = { bg = theme.ui.color_column },
        ...
        CursorLineNr = { fg = theme.ui.cursor_line_number, bg = theme.ui.bg_gutter, bold = true },
        ...
        StatusLine = { fg = theme.ui.fg_gray, bg = theme.ui.bg_p1 },
        ...
        DiagnosticLuaLineError = { fg = theme.diag.lualine_error, bg = theme.ui.bg_p1 },
        DiagnosticLuaLineWarn = { fg = theme.diag.lualine_warning, bg = theme.ui.bg_p1 },
        DiagnosticLuaLineInfo = { fg = theme.diag.lualine_info, bg = theme.ui.bg_p1 },
        DiagnosticLuaLineHint = { fg = theme.diag.lualine_hint, bg = theme.ui.bg_p1 },
        DiagnosticLuaLineOk = { fg = theme.diag.lualine_ok, bg = theme.ui.bg_p1 },
